                                            ...
                                            <table className="w-full text-center text-xs sm:text-sm">
                                                <thead>
                                                    <tr className={darkMode ? 'bg-gray-600' : 'bg-gray-100'}>
                                                        ...
                                                        <th className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300 hidden sm:table-cell" title="Empates">E</th>
                                                        {/* <th className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300 hidden sm:table-cell">%V</th> */}
                                                        ...
                                                        <tr key={jogador.id} className={index % 2 === 0 ? (darkMode ? 'bg-gray-600' : 'bg-gray-50') : ''}>
                                                            ...
                                                            <td className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300 text-left font-medium min-w-[100px] sm:min-w-0 break-words">
                                                                ...
                                                                <div className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                                                    {jogador.torneios_participados} torn.
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300 font-semibold text-gray-500 dark:text-gray-400 hidden sm:table-cell">
                                                                {jogador.empates}
                                                            </td>
                                                            {/* <td className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300 hidden sm:table-cell">
                                        ...
                                        {activeTab === 'duplas' && (
                                            <table className="w-full text-center text-xs sm:text-sm">
                                                <thead>
                                                    <tr className={darkMode ? 'bg-gray-600' : 'bg-gray-100'}>
                                                        <th className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300 w-8 sm:w-auto">#</th>
                                                        <th className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300">Dupla</th>
                                                        <th className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300" title="Vitórias">V</th>
                                                        <th className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300" title="Derrotas">D</th>
                                                        <th className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300 hidden sm:table-cell" title="Empates">E</th>
                                                        {/* <th className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300 hidden sm:table-cell">%V</th> */}
                                                        <th className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300" title="Saldo">S</th>
                                                        <th className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300" title="Média de Pontos">MP</th>
                                                        <th className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300" title="Total de Jogos">J</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    {filterItems(duplas, search).map((dupla, index) => (
                                                        <tr key={dupla.id} className={index % 2 === 0 ? (darkMode ? 'bg-gray-600' : 'bg-gray-50') : ''}>
                                                            <td className={`py-1 sm:py-2 px-1 sm:px-3 border border-gray-300 ${getRankingColor(dupla.posicao)}`}>
                                                                <div className="flex items-center justify-center gap-1 flex-wrap">
                                                                    <span>{dupla.posicao}</span>
                                                                    {dupla.posicao <= 3 && (
                                                                        <span className="text-[10px] sm:text-base">
                                                                            {dupla.posicao === 1 && '🥇'}
                                                                            {dupla.posicao === 2 && '🥈'}
                                                            ...
                                                            <td className="py-1 sm:py-2 px-1 sm:px-3 border border-gray-300 text-left font-medium min-w-[100px] sm:min-w-0 break-words">
                                                                <div className="line-clamp-2 leading-tight">{dupla.nome}</div>
                                                                <div className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                                            ...
                                                            <td className={`py-1 sm:py-2 px-1 sm:px-3 border border-gray-300 ${dupla.saldo_pontos >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-500 dark:text-red-400'}`}>
